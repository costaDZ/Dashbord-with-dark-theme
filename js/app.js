...
let category_options = {
    series: [44, 55, 41, 17, 12],
    labels: ['Cloths', 'Devices', 'Bags', 'Watches', 'test'],
    chart: {
        type: 'donut',
    },
    colors: ['#6ab04c', '#2980b9', '#f39c12', '#d35400', '#d31400']
}

let category_chart =
    new ApexCharts(document.querySelector("#category-chart"), category_options)
...
let customer_chart =
    new ApexCharts(document.querySelector("#customer-chart"), customer_options)
